...
export function buildCLI() {
    ...
    jkanimeCmd
        .command("fetch")
        .description("Fetch tracked anime & watch statuses from JKanime user profile into mappings.json")
        .action(async () => {
    ...
    animeav1Cmd.command('scrape')
        ...
        if (!session)
            throw new Error('ANIMEAV1_SESSION environment variable is required');
